...
The sources for indiapins can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/pawangeek/indiapins
.. _tarball: https://github.com/pawangeek/indiapins/tarball/master
